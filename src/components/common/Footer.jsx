        ...
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 flex justify-between lg:mt-16">
              <div className="flex-1">
                ...
                <p className="mt-4 text-sm text-gray-300 dark:text-gray-200">
                  We are a dynamic and innovative company focused on providing
                  top-notch services for businesses across various industries.
                  Our mission is to deliver excellence in every project,
              ...
              <div className="flex-1">
                <p className="font-medium  text-white dark:text-white mx-8">
                  Contact
                </p>
                <ul className="mt-6 space-y-4 text-sm">
          ...
          <div className="mt-12">
            <p className="text-xs text-center text-white dark:text-gray-400">
              &copy; 2022. Talent Hunt. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
